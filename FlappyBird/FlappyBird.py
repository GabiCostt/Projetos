...
class Passaro:
    ...
    def desenhar(self, tela):
        # definir a imagem do passaro que vai ser usada
        ...
        pos_centro_imagem = self.imagem.get_rect(topletf=(self.x, self.y)).center
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    texto.blit(texto, (TELA_LARGURA - 10 - texto.get_width(), 10))
    chao.desenhar(tela)
